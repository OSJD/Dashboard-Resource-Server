...
import com.ht.api.exception.CustomAccessDeniedHandler;
import com.ht.api.filter.CsrfCookieFilter;
...
/*    @Value("${spring.security.oauth2.resourceserver.opaque.introspection-client-id}")
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        jwtAuthenticationConverter.setJwtGrantedAuthoritiesConverter(new HTRoleConverter());
        ...
        http.sessionManagement(sessionConfig -> sessionConfig.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/portal-login").hasAnyRole("USER", "ADMIN")
